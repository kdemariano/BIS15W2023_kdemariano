...
```r
good_hero <- superhero_info %>% 
  filter(alignment=="good")
```


```r
bad_hero <- superhero_info %>% 
...
```r
"We do not have 16 rows total in question 10 but have 14 because thare are heros who are both taller than 300 and weight greater than 450 "
```

```
## [1] "We do not have 16 rows total in question 10 but have 14 because thare are heros who are both taller than 300 and weight greater than 450 "
```
...
## # … with 724 more rows, and 2 more variables: weight <dbl>, ratio <dbl>
```
...
## # … with 17 more variables: weapons_master <lgl>, intelligence <lgl>,
## #   super_strength <lgl>, telepathy <lgl>, energy_blasts <lgl>,
## #   super_speed <lgl>, enhanced_senses <lgl>, telekinesis <lgl>, jump <lgl>,
## #   reflexes <lgl>, force_fields <lgl>, psionic_powers <lgl>,
## #   precognition <lgl>, hypnokinesis <lgl>, light_control <lgl>,
## #   illusions <lgl>, the_force <lgl>
```
